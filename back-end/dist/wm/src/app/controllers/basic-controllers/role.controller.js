...
class RoleController extends controllers_1.BaseController {
    constructor(sequelize) {
        super({
            service: new services_1.RoleService(sequelize),
            childService: new services_1.AccountService(sequelize),
        });
        this.useCreate = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const model = new view_models_1.RoleCM(req.body);
        ...
        this.useUpdate = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const model = new view_models_1.RoleUM(req.body);
