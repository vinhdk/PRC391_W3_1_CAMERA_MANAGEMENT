...
class OrderDetailController extends controllers_1.BaseController {
    constructor(sequelize) {
        super({
            service: new services_1.OrderDetailService(sequelize),
            childService: null,
        });
        this.useCreate = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const model = new view_models_1.OrderDetailCM(req.body);
        ...
        this.useUpdate = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const model = new view_models_1.OrderDetailUM(req.body);
