...
class CategoryController extends controllers_1.BaseController {
    constructor(sequelize) {
        super({
            service: new services_1.CategoryService(sequelize),
            childService: new services_1.CameraService(sequelize),
        });
        this.useCreate = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const model = new view_models_1.CategoryCM(req.body);
        ...
        this.useUpdate = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const model = new view_models_1.CategoryUM(req.body);
