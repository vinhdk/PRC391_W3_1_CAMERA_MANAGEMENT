...
exports.BrandRouter = (app, sequelize) => {
    const AUTH = new controllers_1.AuthController(sequelize).useAuthorzie;
    const CONTROLLER = new controllers_1.BrandController(sequelize);
    app.route(environment_1.environment.apiLink.basic.brand.main)
    ...
    app.route(environment_1.environment.apiLink.basic.brand.getById)
        .get(AUTH, (req, res, next) => {
