...
exports.CameraRouter = (app, sequelize) => {
    const AUTH = new controllers_1.AuthController(sequelize).useAuthorzie;
    const CONTROLLER = new controllers_1.CameraController(sequelize);
    app.route(environment_1.environment.apiLink.basic.camera.main)
    ...
    app.route(environment_1.environment.apiLink.basic.camera.getById)
        .get(AUTH, (req, res, next) => {
